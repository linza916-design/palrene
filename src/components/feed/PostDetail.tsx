...
export default function PostDetail() {
    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-8 space-y-4 text-center">
        ...
        <p className="text-xs text-neutral-550 max-w-sm">
          We couldn't anchor the specific story you seek. It might have drifted
          or been deleted.
        </p>
        <button
  ...
  const getTailoredAd = () => {
    ...
    if (
      loweredContent.includes("chopin") ||
      loweredContent.includes("music") ||
      loweredContent.includes("vinyl")
    ) {
      return {
        title: "Acoustic Vintage Vinyl Store 📻",
        description:
          "Immerse yourself in authentic analog frequencies. Certified first-press classical & jazz restocked.",
      ...
      loweredContent.includes("cosmic") ||
      loweredContent.includes("philosophy") ||
      loweredContent.includes("universe")
    ) {
      return {
        title: "Cosmic Resonance Retreats 🌌",
        description:
          "Align your internal vibration with deep space sound bath meditations. Starts July 2026.",
      ...
      loweredContent.includes("connection") ||
      loweredContent.includes("empathy") ||
      loweredContent.includes("ai")
    ) {
      return {
        title: "Poly Empathy Guidance Premium 🤖🧡",
        description:
          "Unlock emotional co-piloting for profound mindfulness. 30 days of seamless companion intelligence.",
      ...
      return {
        ...
        description:
          "Organic hand-picked lavender, chamomile and roasted oolong. Quiet moments designed in Kyoto.",
  ...
  const getSidebarSuggestions = () => {
    ...
    return [
      {
        id: "s-7",
        text: "How to craft a secure psychological harbor in a hyperactive world?",
        views: "12k views",
        isReal: false,
      },
      {
        id: "s-8",
        text: "The deep science of sharing silent spaces with loved ones",
        views: "6.8k views",
        isReal: false,
      },
      {
        id: "s-9",
        text: "When is vulnerable storytelling considered a modern superpower?",
        views: "15k views",
        isReal: false,
      },
    ];
      ...
      <div className="bg-neutral-50 dark:bg-zinc-900/90 border-b border-neutral-150/50 dark:border-zinc-850 px-4 py-2 flex items-center justify-between gap-4 sticky top-0 z-40 backdrop-blur-md">
        ...
        <div className="flex items-center gap-1.5 text-xs font-mono text-neutral-400 dark:text-zinc-500">
          ...
          <span>
            ...
            {String(activeSeconds % 60).padStart(2, "0")}s
          </span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-neutral-800 dark:text-white flex items-center gap-1 shadow-sm">
                      ...
                      {post.profile.is_verified && (
                        <span className="w-3.5 h-3.5 rounded-full bg-orange-500/10 text-orange-500 text-[8px] flex items-center justify-center font-bold">
                          ✔
                        </span>
                      )}
                    </h3>
                ...
                <div className="flex items-center gap-1">
                  <span className="px-2.5 py-1 bg-stone-100 dark:bg-zinc-900 font-mono text-[9px] rounded-full text-neutral-450 uppercase tracking-widest">
              ...
              <div className="relative text-stone-700 dark:text-zinc-200 font-serif leading-relaxed text-sm antialiased wrap-break-word select-text pt-2">
                {shouldBlur && (
                  <div className="absolute inset-0 z-30 bg-black/10 backdrop-blur-md flex items-center justify-center rounded-2xl pointer-events-none">
                    <span className="flex items-center gap-1 bg-neutral-900 border border-white/10 px-3 py-1.5 rounded-full text-[10px] font-mono uppercase tracking-wider text-white">
                      <Eye size={12} /> Double-Click statement to clear blurry
                      veil
                    </span>
                  </div>
                )}
                ...
                <p
                  className={`${shouldBlur ? "blur-md select-none hover:blur-sm contrast-125 duration-300" : ""}`}
                >
                  {post.content}
                </p>
              </div>
              ...
              {post.media_urls && post.media_urls.length > 0 && (
                <div
                  className={`rounded-2xl overflow-hidden border border-neutral-100 dark:border-neutral-950 aspect-video relative max-h-96 ${
              ...
              {post.giphy_url && (
                <div
                  className={`rounded-xl overflow-hidden max-h-72 border border-neutral-100 dark:border-neutral-950 flex items-center justify-center ${
                    shouldBlur ? "blur-md select-none" : ""
                  }`}
                >
                  <img
                ...
                <div className="p-5 bg-neutral-50/70 dark:bg-zinc-900/30 border border-neutral-200/50 dark:border-zinc-850 rounded-2xl space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-[10px] font-mono tracking-widest uppercase font-bold text-orange-500">
                        Interactive Quora Quiz
                      </span>
                    </div>
                    {isQuizVoted && (
                  ...
                  <div className="space-y-2.5">
                    {post.quiz.options.map((opt, idx) => {
                      ...
                      let borderClass =
                        "border-neutral-200 dark:border-zinc-800 hover:border-orange-500/40 bg-white/50 dark:bg-black/20";
                      ...
                      if (isQuizVoted) {
                        if (isCorrect) {
                          ...
                          borderClass =
                            "border-green-500/70 bg-green-500/[0.05] dark:bg-green-950/[0.12]";
                          indicatorColor = "text-green-500 font-bold";
                        } else if (selectedThis) {
                          // Wrong selected returns RED highlight
                          borderClass =
                            "border-red-500/70 bg-red-500/[0.05] dark:bg-red-950/[0.12]";
                          indicatorColor = "text-red-500 font-bold";
                        } else {
                          // Unselected un-correct
                          borderClass =
                            "border-neutral-200 dark:border-zinc-800 bg-neutral-50/20 dark:bg-black/10 opacity-70";
                        }
                      }
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="relative flex items-center space-x-2.5 z-10">
                            {isQuizVoted && isCorrect && (
                              <Check size={14} className="text-green-500" />
                            )}
                            {isQuizVoted && selectedThis && !isCorrect && (
                          ...
                          {isQuizVoted && (
                            <span
                              className={`relative text-[10px] font-mono ${indicatorColor} z-10`}
                            >
                  ...
                  <AnimatePresence>
                    {isQuizVoted && (
                      <motion.div
                        ...
                        className="p-4 bg-orange-500/3 dark:bg-zinc-900/60 border border-orange-500/20 rounded-xl space-y-3 mt-1.5"
                      >
                        <div className="flex items-center gap-1.5 text-orange-500">
                          <Lightbulb size={14} />
                          <span className="text-[10px] font-bold uppercase tracking-wider font-mono">
                            Creator explanation & context
                          </span>
                        </div>
                        <p className="text-xs text-neutral-700 dark:text-zinc-300 italic font-serif leading-relaxed pl-5 border-l-2 border-orange-500/40">
                          ...
                          {post.quiz.explanation ||
                            "Constructed with dynamic stardust parameter guidance. True understanding builds deeper empathy."}
                          "
                        </p>
                        ...
                        {post.quiz.lead_link && (
                          <div className="pt-2 flex justify-end">
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="px-3.5 py-1.5 text-[10px] font-mono font-bold uppercase tracking-wider bg-linear-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 rounded-lg text-white shadow-sm hover:shadow flex items-center gap-1 transition-transform hover:scale-102"
                            >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="p-4 bg-orange-500/2 dark:bg-zinc-950/20 border border-orange-500/20 rounded-2xl space-y-3 leading-normal">
              ...
              <div className="flex justify-between items-center font-mono">
                <span className="text-[10px] text-neutral-450">
                  Active Read stopwatch:
                </span>
                <span className="text-xs font-bold text-orange-400">
                  {activeSeconds} seconds interest time
                </span>
              </div>
              <p className="text-[9.5px] italic text-neutral-400 font-sans leading-normal">
                Behind the scenes, the algorithm registers this focus duration
                to scale up this topic in your recommended dashboard.
              </p>
            </div>
            ...
            <div className="p-4 bg-white dark:bg-zinc-950/45 border border-neutral-150/45 dark:border-neutral-900 rounded-2xl space-y-3 relative overflow-hidden text-left leading-normal">
              <div className="flex justify-between items-start">
                <span className="text-[8px] font-mono font-bold tracking-widest text-[#B92B27] dark:text-[#E04B45] uppercase border border-red-500/20 px-2 py-0.5 rounded-full">
                  Quora SPONSORED
                </span>
            ...
            <div className="p-4 bg-white dark:bg-zinc-950/45 border border-neutral-150/45 dark:border-neutral-900 rounded-2xl space-y-3 text-left leading-normal">
              ...
              <span className="text-[10px] text-neutral-450 block">
                Suggested threads from similar spaces:
              </span>
              ...
              <div className="divide-y divide-neutral-100/60 dark:divide-zinc-850 space-y-2.5">
                {suggestions.map((s) => (
                  <div
                    key={s.id}
                    className="pt-2.5 space-y-1 hover:opacity-95 transition"
                  >
                    <button
                      onClick={() => {
                        if (s.isReal) {
                          ...
                          setTimeout(() => {
                            document
                              .getElementById("post-detail-scroll-container")
                    ...
                    <div className="flex items-center justify-between text-[9px] text-neutral-400 font-mono">
                      <span>{s.views}</span>
                      <span className="px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-500 uppercase text-[7px] tracking-wider font-bold">
                        Trending space
                      </span>
                    </div>
                  </div>
