...
export default function SettingsPanel() {
  ...
  const detectCardType = (num: string) => {
    ...
    if (num.startsWith("2") || num.startsWith("6"))
      return "Verve Global Secured";
  ...
  const billingTiers = [
    ...
    },
    {
      ...
      billNote: isAnnual
        ? (billingCycles.Annual as any).noteStarter
        : "Billed monthly",
      desc: "Unlock manual verification seals and secure deeper matching tunnels.",
      badge: "Prestige Seeker",
      color:
        "border-yellow-500/20 shadow-[0_0_15px_rgba(245,158,11,0.05)] bg-gradient-to-br from-yellow-500/[0.01]",
      features: [
    ...
    },
    {
      ...
      price: prices.Pro,
      billNote: isAnnual
        ? (billingCycles.Annual as any).notePro
        : "Billed monthly",
      desc: "Unbound creative influence, community forge templates, and ad placements.",
      badge: "Cosmic Architect",
      color:
        "border-orange-500/30 shadow-[0_0_20px_rgba(249,115,22,0.08)] bg-gradient-to-br from-orange-500/[0.02]",
      features: [
      ...
      <div className="flex items-center justify-between border-b border-neutral-150/40 dark:border-neutral-900 pb-4">
        <div>
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400">
            Manage payment plans, smart ad campaigns, and Safeguards
            configurations.
          </p>
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`flex-1 flex items-center justify-center space-x-2 py-2.5 rounded-xl text-xs font-mono font-bold transition outline-none cursor-pointer ${
                isChosen
                  ? "bg-linear-to-r from-red-500 to-orange-500 text-white shadow-md shadow-orange-950/10"
      ...
      {activeTab === "billing" && (
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-3xl border border-neutral-150/50 dark:border-neutral-900 bg-neutral-50 dark:bg-zinc-950/20">
            <div>
              <span className="text-xs font-bold text-neutral-800 dark:text-white block font-sans">
                Flexible Billing Cycles
              </span>
              <p className="text-[10.5px] text-neutral-400">
                Save 35% on standard fees when committing to annual soul orbits.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-2 bg-neutral-100 dark:bg-zinc-900 p-1 rounded-2xl border border-neutral-200 dark:border-neutral-850 relative shrink-0">
              ...
              >
                <span>Annual</span>
                <span className="bg-orange-500 text-white font-bold px-1 rounded-sm text-[7.5px] leading-3 uppercase tracking-wider scale-95 origin-right">
                  Save 35%
                </span>
              </button>
            </div>
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-3xl border relative overflow-hidden transition-all duration-300 ${tier.color} ${
                    isChosen
                      ? "ring-2 ring-orange-500 border-transparent bg-orange-500/1"
                ...
                >
                  ...
                  {isChosen && isPro && (
                    <div className="absolute inset-x-0 top-0 h-[2.5px] bg-linear-to-r from-red-500 via-yellow-400 to-orange-500 animate-pulse" />
                  )}

                  {/* Active Badge banner */}
                  {isChosen && (
                    <span className="absolute top-0 right-0 px-3 py-1 bg-linear-to-r from-red-500 to-orange-500 text-white font-mono text-[8px] uppercase tracking-wider font-bold rounded-bl-xl select-none leading-none flex items-center gap-1 z-10 shadow">
                      <Check size={8} className="stroke-[3.5]" /> Active
                      Resonance
                    </span>
                  )}
                  ...
                  <div className="flex items-start justify-between relative z-10">
                    <div className="text-left space-y-1">
                      ...
                      <h4 className="text-md font-serif font-black dark:text-white pt-2 leading-none">
                        {tier.id} Plan
                      </h4>
                    ...
                    {!isChosen && (
                      <button
                        ...
                        className="px-4 py-2.5 text-[10px] font-mono font-bold uppercase tracking-wider text-white bg-linear-to-r from-red-500 via-orange-500 to-rose-600 hover:scale-[1.03] active:scale-97 rounded-xl transition shadow shadow-orange-950/10 leading-none cursor-pointer flex items-center"
                      >
                        Resonate Orbit
                      </button>
                    )}
                  ...
                  <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-[10.5px] text-neutral-500">
                    {tier.features.map((feature, fIdx) => (
                      <div
                        key={fIdx}
                        className="flex items-center space-x-2 min-w-0 font-serif leading-tight"
                      >
          ...
          <div className="p-5 bg-neutral-50 dark:bg-zinc-950/25 border border-neutral-150/45 dark:border-neutral-900 rounded-3xl space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                <span className="font-bold text-neutral-800 dark:text-white block font-sans text-xs">
                  Daylight Blurring Safeguard
                </span>
                <p className="text-[11px] text-neutral-400 leading-normal">
                  Ensures sensitive feed media uploads and profile elements
                  start blurred between 6 AM and 6 PM. Requires a simple
            ...
            <div className="flex items-start justify-between gap-4 pt-4 border-t border-neutral-100/60 dark:border-neutral-900/45">
              <div className="space-y-1">
                <span className="font-bold text-neutral-800 dark:text-white block font-sans text-xs">
                  Simulated Dispatch Digests
                </span>
                <p className="text-[11px] text-neutral-400 leading-normal">
                  Allows the Palrene server mock system to trigger safe
                  notifications and email simulation transcripts whenever people
                  message or request matches.
                </p>
              </div>
              <input
                type="checkbox"
      ...
      {activeTab === "ads" && (
        <div className="space-y-4">
          {currentUser && currentUser.subscription_tier !== "Pro" ? (
            <div className="p-8 text-center bg-linear-to-br from-red-500/15 via-orange-500/10 to-rose-500/15 border border-orange-500/15 dark:border-orange-500/10 rounded-3xl space-y-4 h-80 flex flex-col justify-center text-left">
              <div className="flex items-center gap-2">
                <Crown className="text-yellow-500 animate-bounce" size={24} />
                <h3 className="text-base font-serif font-black text-neutral-800 dark:text-white">
                  Smart Category Ad Builder
                </h3>
              </div>
              <p className="text-xs text-neutral-500 dark:text-neutral-400 max-w-sm leading-relaxed font-serif">
                Reach thousands of like-minded humans! Ad creation, custom
                budget estimators, demographics filtering, visual carousel
                banners, and Smart Category matchmaking are strictly unlocked
                for **Pro Tier Cosmic Architects**.
              </p>
              <div className="pt-2">
                <button
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center bg-neutral-50 dark:bg-zinc-950/20 border border-neutral-150/45 dark:border-neutral-900/60 p-4 rounded-3xl">
                <div>
                  ...
                  <p className="text-[10px] text-neutral-450 mt-1">
                    Submit high-prestige sponsored slots into category
                    dashboards.
                  </p>
                </div>
                {!showAdBuilder && (
              ...
              {showAdBuilder ? (
                <form
                  onSubmit={handleAdPublish}
                  className="p-5 bg-neutral-50 dark:bg-zinc-950/25 border border-neutral-150/50 dark:border-neutral-900 rounded-3xl space-y-4"
                >
                  <div className="flex items-center justify-between border-b border-neutral-200 dark:border-neutral-850 pb-2">
                    <span className="text-xs font-mono font-bold text-neutral-800 dark:text-zinc-200 uppercase tracking-wider">
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-neutral-400 dark:text-neutral-500 uppercase block font-bold">
                      Concept Pitch / Call to Action Description
                    </label>
                    <textarea
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        <option value="relationships">
                          Relationships & Matches (Premium Feed)
                        </option>
                        ...
                        <option value="science">
                          Deep Science & Psychology
                        </option>
                        <option value="travel">
                          Travel & Solitude Retreats
                        </option>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-mono text-neutral-450 dark:text-neutral-500 uppercase block font-bold">
                      Promo High-Res Creative Banner
                    </label>
                    <div className="grid grid-cols-4 gap-2 pt-0.5">
                      {presetBannerImages.map((b) => (
                        ...
                        >
                          ...
                          />
                          <span className="absolute bottom-0 inset-x-0 text-center bg-black/60 text-[7.5px] text-white font-mono leading-3 py-0.5 uppercase truncate">
                            {b.label}
                          </span>
                        </div>
                      ))}
                  ...
                  <div className="pt-2 flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="flex-1 py-2 font-mono text-[10px] font-bold uppercase tracking-wider text-white bg-linear-to-r from-red-500 to-orange-500 rounded-xl"
                    >
                ...
                <div className="space-y-4">
                  {userAds.length === 0 ? (
                    <div className="p-10 border border-neutral-150/50 dark:border-neutral-900 rounded-3xl bg-neutral-50 dark:bg-zinc-950/20 text-center">
                      <Crown
                        size={24}
                        className="mx-auto text-neutral-350 dark:text-zinc-800"
                      />
                      <p className="text-xs text-neutral-400 mt-2 font-mono">
                        No promotions registered. Press Forge Ad to establish
                        your first pitch!
                      </p>
                    </div>
                  ) : (
                        ...
                        >
                          ...
                          <div className="flex-1 space-y-2 text-left leading-normal">
                            <div className="flex items-center justify-between">
                              <span
                                className={`text-[8.5px] font-mono font-bold px-2 py-0.5 rounded border ${
                                  ad.status === "approved"
                            ...
                            <div>
                              ...
                              <p className="text-[11px] text-neutral-500 mt-0.5 line-clamp-2 italic">
                                "{ad.description}"
                              </p>
                            </div>
        ...
        {payingForTier && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-zinc-950 border border-neutral-100 dark:border-neutral-900 rounded-4xl w-full max-w-sm overflow-hidden text-left relative shadow-2xl"
            >
              {checkoutStep === "input" && (
                <div className="p-5 sm:p-6 space-y-5">
                  ...
                  <div className="p-4 bg-neutral-50 dark:bg-zinc-900/60 rounded-2.5xl space-y-1 relative overflow-hidden text-xs">
                    <span className="text-[10px] text-neutral-400 font-mono block">
                      UPGRADE TARGET ORBIT LEVEL
                    </span>
                    <h4 className="text-sm font-serif font-black dark:text-white leading-none pt-0.5">
                    ...
                    <span className="text-[9px] text-neutral-450 block font-mono italic">
                      {isAnnual
                        ? "*Billed once for 365 days lock"
                        : "*Billed relative to monthly cadence"}
                    </span>
                  </div>
                    ...
                    <div className="space-y-3.5 text-xs">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          value={cardNumber}
                          onChange={(e) =>
                            setCardNumber(getFormatCardValue(e.target.value))
                          }
                          className="w-full text-xs p-2.5 rounded-xl border border-neutral-250 bg-white dark:bg-black dark:border-neutral-850 dark:text-white font-mono outline-none"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setCardExpiry(
                                getFormatOptionValue(e.target.value),
                              )
                            }
                  ...
                  {paymentChannel === "mobile_money" && (
                    <div className="space-y-4 text-xs">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-mono text-neutral-400 uppercase block font-bold">
                          Active Mobile Account Connection
                        </label>
                        <input
                          type="tel"
                    ...
                    <div className="space-y-4 text-xs">
                      <div className="p-4 bg-neutral-100 dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-850 rounded-2.5xl space-y-2 font-mono text-[10.5px] leading-relaxed text-neutral-550 dark:text-neutral-350">
                        ...
                        <div className="text-[9px] text-neutral-400 text-center pt-1 italic font-serif">
                          *A unique settlement address created for your intimate
                          security. Transfer settles immediately.
                        </div>
                      </div>
                      ...
                      <div className="text-[10px] text-center font-serif text-neutral-400 flex items-center justify-center gap-1">
                        ...
                        <span>
                          After transferring matching sum, press Confirm below.
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full py-3.5 bg-linear-to-r from-red-500 via-orange-500 to-rose-600 hover:scale-[1.01] active:scale-99 text-white font-mono text-[10px] font-bold uppercase tracking-wider rounded-2xl cursor-pointer shadow-lg leading-none"
                    >
              ...
              {checkoutStep === "processing" && (
                <div className="p-8 text-center space-y-5">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-sm font-mono font-bold uppercase tracking-wider text-neutral-800 dark:text-zinc-200">
              ...
              {checkoutStep === "success" && (
                <div className="p-6 text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-md font-serif font-black text-neutral-800 dark:text-white">
                      Resonance Level Synchronized!
                    </h4>
                    <p className="text-xs text-neutral-500 dark:text-neutral-350 leading-relaxed font-serif px-2">
                      Your ledger transactions completed successfully. Your
                      profile parameters now list at level **{payingForTier.id}
                      ** with full matching credentials.
                    </p>
                  </div>
...
function GlowIcon(Icon: any) {
  return function (props: any) {
    return (
      <Icon {...props} className={`${props.className || ""} text-orange-500`} />
    );
  };
}
